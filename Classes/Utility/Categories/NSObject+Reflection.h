...
/// @discussion This method faster than creating an \c FLEXIvar and calling \c -getIvarAddress: if you already have an \c Ivar on hand
/// @return The address of the given instance variable in the recieving object in memory, or \c NULL if it could not be found\.
...
/// @discussion Use only when the target instance variable is an object.
/// This method is faster than creating an \c FLEXIvar and calling \c -setIvar: if you already have an \c Ivar on hand.
...
/// Sets the value of the given instance variable on the recieving object to the \e size number of bytes of data at \e value.
/// @discussion This is faster than creating an \c FLEXIvar and calling \c -setIvar:value:size if you already have an \c Ivar on hand.
...
+ (NSArray<FLEXProperty*> *)allProperties;
